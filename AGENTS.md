...
- Run `python3 scripts/validate.py`, `python3 scripts/test_sync_agent_stack.py`, `python3 scripts/test_sync_instructions.py`, `python3 scripts/test_sync_opencode_config.py`, and the installer tests after relevant changes.
